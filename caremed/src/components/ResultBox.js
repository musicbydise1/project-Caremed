        ...
        <div>
            <div className="result-boxes grid">
                <div className="grid left">
                    <div className="result-box rgb-gray">
                    <div className="result-box-container">
                        ...
                        <div className="result-box-row">
                            ...
                            <div className="result-box-cell">
                                ...
                                Autism spectrum disorder begins in early childhood and eventually causes problems functioning in society — socially, in school and at work, for example. Often children show symptoms of autism within the first year. A small number of children appear to develop normally in the first year, and then go through a period of regression between 18 and 24 months of age when they develop autism symptoms.</p>
                            </div>
                        </div>
                    </div>
                </div>

                    <div className="result-box rgb-blue">
                        <div className="result-box-container">
                            <div className="result-box-row">
                                <div className="result-box-main">
                                    <p><b>Diagnosis</b></p>
                            ...
                            <div className="result-box-row">
                                ...
                                <div className="result-box-cell">
                                    <p>Some children show signs of autism spectrum disorder in early infancy, such as reduced eye contact, lack of response to their name or indifference to caregivers. Other children may develop normally for the first few months or years of life, but then suddenly become withdrawn or aggressive or lose language skills they've already acquired. Signs usually are seen by age 2 years.
                                        ...
                                        Because of the unique mixture of symptoms in each child, severity can sometimes be difficult to determine. It's generally based on the level of impairments and how they impact the ability to function.%</p>
                                </div>
                            </div>
