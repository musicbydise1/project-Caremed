                ...
                <nav>
                    ...
                    <div>
                        <ul id="navbar" className="blc">
                            ...
                            <li className="lang blc cursor-pointer ml-[150px]" onClick={toggleDropdown}>
                                <FaGlobe className="globus blc" size={25}></FaGlobe>
                                {isDropdownOpen && (
                            ...
                            <li className="lang ml-[15px]" style={{ padding: "7px 20px" }} onClick={toggleUserDropdown}>
                                <FaUser className="globus blc cursor-pointer" size={25}></FaUser>
                                {isUserDropdownOpen && (
                                    <ul className="language-dropdown">
